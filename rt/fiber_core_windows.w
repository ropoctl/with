// rt/fiber_core_windows.w -- Windows fiber core.
//
...
fn fiber_write_i32(fd: i32, n: i32):
    ...
    var i = 0
    if value < 0:
        let _ = rt_write(fd, "-" as *const u8, 1)
        value = 0 - value
    if value == 0:
        let _ = rt_write(fd, "0" as *const u8, 1)
        return
...
pub fn with_fiber_bootstrap_finish() -> Unit:
    ...
    fiber_set_completion_sequence(current_fiber, completion_sequence)
