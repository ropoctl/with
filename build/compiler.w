...
fn comp_internal_command(item: str) -> bool:
    item == "ast" or item == "bench" or item == "clean" or item == "fixpoint-diff" or item == "get" or item == "install-user" or item == "ir" or item == "lsp" or item == "reduce" or item == "remove" or item == "tokens"
