...
fn comp_internal_command(item: str) -> bool:
    item == "analyze" or item == "ast" or item == "bench" or item == "clean" or item == "fixpoint-diff" or item == "get" or item == "install-user" or item == "ir" or item == "lsp" or item == "reduce" or item == "remove" or item == "tokens"

fn comp_internal_flag(item: str) -> bool:
    item == "--alloc" or item == "--check" or item == "--c-export-functions" or item == "--contains" or item == "--convert-goto-to-structured" or item == "--debug-alloc-filter" or item == "--deterministic" or item == "--diff" or item == "--dry-run" or item == "--dump-abi" or item == "--dump-ast" or item == "--dump-async-mir" or item == "--dump-drop-flags" or item == "--dump-drop-plan" or item == "--dump-drop-state" or item == "--dump-mir" or item == "--dump-place-map" or item == "--dump-project-info" or item == "--dump-resolved" or item == "--dump-tokens" or item == "--dump-typed" or item == "--exclude" or item == "--exit-code" or item == "--explain" or item == "--explain-mir-origin" or item == "--filter" or item == "--force" or item == "--force-reinstall" or item == "--freestanding" or item == "--graph" or item == "--help" or item == "--ir-roundtrip" or item == "--lib" or item == "--migrate-one" or item == "--name" or item == "--no-c-export" or item == "--no-deps" or item == "--no-prelude" or item == "--no-runtime" or item == "--out" or item == "--output" or item == "--prefer-brace" or item == "--prefer-colon" or item == "--prefer-curly" or item == "--prelude" or item == "--quiet" or item == "--shared-defs" or item == "--shared-fragment" or item == "--stats" or item == "--trace-cleanup-edge" or item == "--trace-ownership" or item == "--trace-place" or item == "--validate-all" or item == "--validate-ownership" or item == "--verbose" or item == "--width-slice" or item == "--version" or item == "-f" or item == "-D" or item == "-g0" or item == "-h" or item == "-I" or item == "-include" or item == "-l" or item == "-o" or item == "-q" or item == "-v" or item == "-w"
