    ...
    mut fn enforce_receiver_modes():
        ...
        for si in 0..self.sig_receiver_modes.len() as i32:
            ...
            if declared == ReceiverMode.Missing:
                ...
                // D21 re-tightens the Mut escalation retired one commit earlier:
                // place-threading now classifies take-and-return pipelines as
                // in-place receiver updates, so a surviving `move` requirement
                // is a genuine consume/escape of the whole receiver.
